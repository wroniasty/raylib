...
RLAPI Shader LoadShaderWithGeometryFromMemory(const char* vsCode, const char* fsCode, const char* gsCode); // Load shader from code strings and bind default locations
